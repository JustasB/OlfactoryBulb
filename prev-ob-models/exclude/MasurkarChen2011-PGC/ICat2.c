...
extern Memb_func* memb_func;
 ...
 "setdata_iCat2", _hoc_setdata,
 "settables_iCat2", _hoc_settables,
 0, 0
};
...
#define cao cao_iCat2
 double cao = 2;
#define cai cai_iCat2
 double cai = 8e-005;
#define usetable usetable_iCat2
 double usetable = 1;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 10, 3);
 	...
 	ivoc_help("help ?1 iCat2 e:/Dropbox/Research/Thesis/MODELS/MasurkarChen2011/ICat2.mod\n");
...
static int _reset;
static char *modelname = "Sustained calcium current from plateau potential-firing rat olfactory glomerular neurons";
...
static int  _f_settables ( _threadargsprotocomma_ double _lv ) {
   double _ltmp ;
 alpha = 1.11 / ( 1.0 + exp ( - 0.058 * ( _lv + 10.0 ) ) ) ;
   _ltmp = _lv + 23.9 ;
   if ( fabs ( _ltmp ) < 1e-6 ) {
