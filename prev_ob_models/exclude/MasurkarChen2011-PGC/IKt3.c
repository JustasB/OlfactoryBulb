...
extern Memb_func* memb_func;
 ...
 "setdata_Ikt3", _hoc_setdata,
 "rates_Ikt3", _hoc_rates,
 "trates_Ikt3", _hoc_trates,
 0, 0
};
...
#define ik ik_Ikt3
 double ik = 0;
#define ntau ntau_Ikt3
 double ntau = 0;
#define ninf ninf_Ikt3
 double ninf = 0;
#define qa qa_Ikt3
 double qa = 16.7;
#define tadj tadj_Ikt3
 double tadj = 0;
#define tha tha_Ikt3
 double tha = 40;
#define usetable usetable_Ikt3
 double usetable = 1;
#define vmax vmax_Ikt3
 double vmax = 60;
#define vmin vmin_Ikt3
 double vmin = -120;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 10, 4);
 	...
 	ivoc_help("help ?1 Ikt3 e:/Dropbox/Research/Thesis/MODELS/MasurkarChen2011/IKt3.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 72 in file IKt3.mod:\n        SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
