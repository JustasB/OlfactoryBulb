...
do
PARAM_FN=/cfs/klemming/nobackup/b/bkaplan/OlfactorySystem/neuron_files/Cluster_ExpDisAffMapping_nGlom30_nHC20_nMC36_rORN100/Parameters/simulation_params.hoc
echo "Starting pattern $PN at `date`"
