...
if __name__ == '__main__':
    ...
    assert (len(sys.argv) > 1), 'Please give the name of the start system (system which has been trained as a pattern classifier,\
            including all parameters to run a full-system simulation including EPTH, OB, OC)'
